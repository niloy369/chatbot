...
args = dict(cuda=False, customer_service='apple', epoch=39, max_seq_len=50, model_path='pretrained-models/apple', sampling_strategy='greedy')
print('Args loaded')
...
VERIFY_TOKEN = 'fgnuSce6cB'# <paste your verify token here>
PAGE_ACCESS_TOKEN = 'EAAmPTGkhSeABAOks7LMMriJS7ZB3s5I3ZAnisNfZAsbdZAGbRIMsHhaQIcyZBYUdC6QD4NOE8HO69ZBR0UWT6x8EUtL6YQ3JwrTE2c9jnAlY1kLHoFkgHtmuwbOI2t7qvkqqpAGceBRIXrasqRZB2VGoR9pwyavDZCkkJwb1Lb4T6CR2ngh65sHlHbjIN17si1gZD'# paste your page access token here>"


def get_bot_response(message):
    """This is just a dummy function, returning a variation of what
    the user said. Replace this function with one connected to chatbot."""
    response = model(message, sampling_strategy=args['sampling_strategy'], max_seq_len=args['max_seq_len'])
    return response
